  ...
  Swal.fire({
    ...
    .then((data) => {
      ...
      try {
        ...
        document.getElementById("subregion").innerHTML = resp.subregion;
        document.getElementById("continents").innerHTML = resp.continents;
        document.getElementById("startOfWeek").innerHTML = resp.startOfWeek;
